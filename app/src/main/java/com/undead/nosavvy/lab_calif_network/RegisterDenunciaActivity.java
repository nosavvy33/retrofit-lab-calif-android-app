...
public class RegisterDenunciaActivity extends AppCompatActivity {
    ...
    private final String TAG = RegisterDenunciaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foto = (ImageView)findViewById(R.id.imagen_preview);
    ...
    public void registrar(View view){
        ...
        String idciu = idciudadano;
        String ubicacion = "-12.15151 -74.212153";
        if (title.isEmpty() || description.isEmpty()) {
            Toast.makeText(this, "Título y Descripcion son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia(title, description,idciu,ubicacion);
        } else {
            ...
            RequestBody idciudPart = RequestBody.create(MultipartBody.FORM, idciu);
            RequestBody ubiPart = RequestBody.create(MultipartBody.FORM, ubicacion);
            call = service.createDenunciaWithPhoto(titlePart, descPart, idciudPart, ubiPart, foto);
        }
